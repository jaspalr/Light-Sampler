 ...
 */
//bug was on line 27 (shown on line 35 in as2-gdb.txt), launch gdbserver, continue till it tells you the error, type up, info locals it shows 
//i = 4294966604 at line 29 which makes no sense, i is unsigned int and i needs to equal to negative number to break from the loop
//which can't happen, so i needs to be signed int 
#include <stdio.h>
#include <stdlib.h>
